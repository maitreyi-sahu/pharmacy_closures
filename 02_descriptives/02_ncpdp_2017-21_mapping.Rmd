---
title: "NCPDP Geocoded Maps for 2017-2021"
...
### Pharmacy openings and closures for 2017-2021
...
ggplot() +  ggtitle("This version has the openings layered on top") +
    ...
    geom_point(data = data, 
               ...
               aes(x = x, y = y, color = `Opening or closure during 2017-21?`), size = 1.2, alpha = .1)+
...
### Pharmacy chain closures by chain, 2017-21

### Pharmacy chain openings by chain, 2017-21
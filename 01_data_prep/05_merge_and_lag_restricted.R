...
id_vars <- c("ncpdp_id", "legal_name", "ncpdp_name", "state_code", "county_fips", "npi")
...
merged_long <- startingDF %>% 
  ...
  left_join(ncpdp_wide %>% select(id_vars, class, classR, type1, type2, type3, type1R, type2R, type3R, community_retail_pharmacy,
                                  chain_name, open24hours, 
  ...
  select(Year, all_of(id_vars), county_name,
         class, classR, type1, type2, type3, type1R, type2R, type3R, community_retail_pharmacy,
         chain_name, open24hours,
